...
const Home = () => {
  ...
  const upcomingEvents = events && Array.isArray(events) && events.length > 0 
    ? events.filter((event: Event) => new Date(event.date) >= new Date()).slice(0, 2)
    : [];
    ...
    <div id="home-page" className="pb-20">
      ...
      <div className="relative bg-gradient-to-br from-primary via-slate-700 to-slate-800 text-white py-12 px-4 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-lg mx-auto">
          ...
          {/* Welcome Message */}
          <h1 className="text-3xl font-bold mb-3 leading-tight">Welcome To The Bear Cave</h1>
